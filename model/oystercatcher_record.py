...
class OysterCatcherRecord:
    """
    Represents a single observation record from the Black OyserCatcher population nesting counts dataset (2008-2017).
    Each instace stores data from one row of the CSV file with attributes matching the dataset column names.
    ...
    def __init__(self, visit_date, site_identification, species, total_black_oystercatcher_adults):
        ...
        def from_row(cls, row):
            ...
            Factory methood that constructs a record object from a dictionary returned by csv.DictReader.
